#!/usr/bin/env python3
"""
Generate the 10 Zsun (overall metallicity) Nagao SED reference Cloudy run,
matched to nitrogen/generate_nagao_ref.py except metals = 10 instead of 1.
...
Output: /Users/jiamuh/c23.01/my_models/nagao_n10_phi19_N24_v100_m10/
        strong_n10_phi19_N24_m10_v100.in

Run:
    python3 nitrogen/generate_nagao_ref_m10.py
then on the Cloudy side:
    cd /Users/jiamuh/c23.01/my_models/nagao_n10_phi19_N24_v100_m10
    ../../source/cloudy.exe -r strong_n10_phi19_N24_m10_v100
"""

import os

OUTDIR = "/Users/jiamuh/c23.01/my_models/nagao_n10_phi19_N24_v100_m10"
PREFIX = "strong_n10_phi19_N24_m10_v100"

CONTENT = f"""\
title BLR Nagao strong bump (matched to aox grid: N24, vturb 100, metals=10)
